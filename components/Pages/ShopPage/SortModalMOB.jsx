...
import DSRadioButton from "../../Theme/DSRadioButton";
      ...
      <div className={st.sortModalMOBBox}>
        <div className="box-sm">
          ...
          <div className={st.filterBtnBox}>
            <main>
              <button className="button button-md button-link-gray">
                {" "}
                Reset{" "}
              </button>
            </main>
