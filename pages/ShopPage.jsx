        ...
        <div className={customGlobals.app}>
            ...
            <div className={st.ShopPage}>
                <div className="box-sm">
                    ...
                    <div className={st.ShopPageGrid}>
                        ...
                        <div className={st.ShopPageGridRight}>
                            ...
                            <div className={st.sortFilterBox}>
                                <main onClick={() => { setSortMob(true) }}><span><SortIcon color="#313130" /> Sort by</span> </main>
                                <main>
                                    <Link href={"/FiltersMob"}>
                                        <span>{/* <div className="ds-indicator"></div> */}<FilterIcon color="#313130" /> Filter</span>
                                    </Link>
                                </main>
                            </div>
                    ...
                    {sortMob ? <SortModalMOB closeSortModal={() => {
                        setSortMob(false)
                    }} /> : null}
                </div>
            </div>
